...
void BrickGeometry::calcualte()
{

}

float* BrickGeometry::get_vertex_array()
{

}

float* BrickGeometry::get_color_array()
{

}

unsigned int* BrickGeometry::get_index_array()
{
