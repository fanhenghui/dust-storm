...
std::shared_ptr<CameraBase> SceneBase::get_camera() { return _camera; }
...
void SceneBase::set_dirty(bool flag) { _dirty = flag; }
...
const std::string &SceneBase::get_name() const { return _name; }
