...
void RCStepMaskNearstSampler::set_gpu_parameter()
{
    ...
    GLBufferPtr buffer_visible_label = inner_buffer->get_buffer(RayCasterInnerBuffer::VISIBLE_LABEL_BUCKET);
    buffer_visible_label->bind_buffer_base(GL_SHADER_STORAGE_BUFFER , BUFFER_BINDING_VISIBLE_LABEL_BUCKET);
}
