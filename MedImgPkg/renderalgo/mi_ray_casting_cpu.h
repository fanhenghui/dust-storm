#ifndef MEDIMGRENDERALGO_RAY_CASTING_CPU_H
#define MEDIMGRENDERALGO_RAY_CASTING_CPU_H
...
private:
    ...
    template <class T> void ray_casting_i(std::shared_ptr<RayCaster> ray_caster);
