...
std::shared_ptr<CameraBase> RayCaster::get_camera() const { return _camera; }
...
void RayCaster::set_ssd_gray(float ssd_gray) { _ssd_gray = ssd_gray; }

void RayCaster::set_jittering_enabled(bool flag) { _enable_jittering = flag; }
...
void RayCaster::set_mask_mode(MaskMode mode) { _mask_mode = mode; }
...
void RayCaster::set_shading_mode(ShadingMode mode) { _shading_mode = mode; }
...
std::shared_ptr<ImageData> RayCaster::get_volume_data() { return _volume_data; }

std::shared_ptr<ImageData> RayCaster::get_mask_data() { return _mask_data; }

std::vector<GLTexture3DPtr> RayCaster::get_volume_data_texture() {
  return _volume_textures;
}

float RayCaster::get_sample_rate() const { return _sample_rate; }
...
MaskMode RayCaster::get_mask_mode() const { return _mask_mode; }

CompositeMode RayCaster::get_composite_mode() const { return _composite_mode; }

InterpolationMode RayCaster::get_interpolation_mode() const {
  return _interpolation_mode;
}

ShadingMode RayCaster::get_shading_mode() const { return _shading_mode; }
...
void RayCaster::set_test_code(int test_code) { _test_code = test_code; }

int RayCaster::get_test_code() const { return _test_code; }
