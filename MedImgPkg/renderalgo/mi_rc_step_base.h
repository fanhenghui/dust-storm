#ifndef MEDIMGRENDERALGO_RAY_CASTING_GPU_STEP_BASE_H
#define MEDIMGRENDERALGO_RAY_CASTING_GPU_STEP_BASE_H
...
class RCStepBase {
public:
  RCStepBase(std::shared_ptr<RayCaster> ray_caster,
  ...
  void set_active_texture_counter(
      std::shared_ptr<GLActiveTextureCounter> tex_counter) {
