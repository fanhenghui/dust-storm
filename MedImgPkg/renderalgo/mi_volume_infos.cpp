...
VolumeInfos::~VolumeInfos() { finialize(); }
...
std::shared_ptr<ImageData> VolumeInfos::get_volume() { return _volume_data; }

std::shared_ptr<ImageData> VolumeInfos::get_mask() { return _mask_data; }
...
std::shared_ptr<BrickPool> VolumeInfos::get_brick_pool() { return _brick_pool; }
