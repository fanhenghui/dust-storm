...
WorkListInfo::WorkListInfo() :
    ...
    m_sAccessionID(""),
    m_sStudyInsUID(""),
    m_sReferringPhysician(""),
    m_sRequestingPhysician(""),
    m_sOperatorsName(""),
    m_sStudyDate(""),
    m_sStudyTime(""),
    m_sStudyDescription(""),
...
{
    if (sPatientSex != "F" && sPatientSex != "M" && sPatientSex != "O" && sPatientSex != "f" && sPatientSex != "m" && sPatientSex != "o")
    {
        std::cout << "WorkListInfo::SetPatientSex() Parameter Check: PatientSex isn't 'F', 'f','M', 'm' or 'O', 'o'." << std::endl;
        return false;
    }
...
bool WorkListInfo::SetReferringPhysician(const std::string& sReferringPhysician)
{
    this->m_sReferringPhysician = sReferringPhysician;
    return true;
}

bool WorkListInfo::SetRequestingPhysician(const std::string& sRequestingPhysician)
{
...
bool WorkListInfo::SetStudyDescription(
    const std::string& sStudyDescription)
{
...
void WorkListInfo::SetRequestedProcedureID(const std::string& sRequestedProcedureID)
{
...
void WorkListInfo::SetScheduledProcedureStepID(const std::string& sScheduledProcedureStepID)
{
...
void WorkListInfo::SetScheduledProcedureStepDescription(const std::string& sScheduledProcedureStepDescription)
{
...
void WorkListInfo::SetScheduledProcedureStepStartDate(const std::string& sScheduledProcedureStepStartDate)
{
...
void WorkListInfo::SetScheduledProcedureStepStartTime(const std::string& sScheduledProcedureStepStartTime)
{
...
void WorkListInfo::SetRequestedProcedureDescription(const std::string& sRequestedProcedureDescription)
{
