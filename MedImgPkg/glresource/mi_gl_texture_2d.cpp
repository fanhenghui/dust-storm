...
GLTexture2D::GLTexture2D(UIDType uid)
    : GLTextureBase(uid), _width(0), _height(0), _format(GL_RGBA),
...
void GLTexture2D::bind() { glBindTexture(GL_TEXTURE_2D, _texture_id); }

void GLTexture2D::unbind() { glBindTexture(GL_TEXTURE_2D, 0); }
...
GLsizei GLTexture2D::get_width() { return _width; }

GLsizei GLTexture2D::get_height() { return _height; }

GLenum GLTexture2D::get_format() { return _format; }
