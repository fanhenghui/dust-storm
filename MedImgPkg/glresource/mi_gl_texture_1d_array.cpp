...
void GLTexture1DArray::unbind() { glBindTexture(GL_TEXTURE_1D_ARRAY, 0); }
...
int GLTexture1DArray::get_width() { return _width; }

int GLTexture1DArray::get_array_size() { return _array_size; }

GLenum GLTexture1DArray::get_format() { return _format; }
