...
unsigned int GLFBO::get_id() const { return _fbo_id; }

void GLFBO::bind() { glBindFramebuffer(_target, _fbo_id); }

void GLFBO::unbind() { glBindFramebuffer(_target, 0); }

void GLFBO::set_target(GLenum target) { _target = target; }

GLenum GLFBO::get_target() { return _target; }
