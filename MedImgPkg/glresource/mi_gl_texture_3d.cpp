...
void GLTexture3D::bind() { glBindTexture(GL_TEXTURE_3D, _texture_id); }

void GLTexture3D::unbind() { glBindTexture(GL_TEXTURE_3D, 0); }
...
GLsizei GLTexture3D::get_width() { return _width; }

GLsizei GLTexture3D::get_height() { return _height; }

GLsizei GLTexture3D::get_depth() { return _depth; }

GLenum GLTexture3D::get_format() { return _format; }
