...
void GLBuffer::set_buffer_target(GLenum target) { _target = target; }

GLenum GLBuffer::get_buffer_target() const { return _target; }
...
unsigned int GLBuffer::get_id() const { return _buffer_id; }
...
void GLBuffer::unbind() { glBindBuffer(_target, 0); }
