...
void MPRScrollBarObserver::set_crosshair_model(std::shared_ptr<medical_imaging::CrosshairModel>
        model) {
    _model = model;
}

void MPRScrollBarObserver::add_scroll_bar(std::shared_ptr<medical_imaging::MPRScene> scene,
        QScrollBar* widget) {
