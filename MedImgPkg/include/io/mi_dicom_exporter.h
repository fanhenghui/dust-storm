#ifndef MEDIMGIO_DICOM_EXPORTER_H
#define MEDIMGIO_DICOM_EXPORTER_H
...
private:
  ...
  IOStatus save_dicom_as_bitmap(const std::string in_files,
                                const std::string out_files);
  ...
  IOStatus save_dicom_as_raw(const std::string in_file_name,
