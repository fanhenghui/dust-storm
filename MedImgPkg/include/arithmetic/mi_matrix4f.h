#ifndef MEDIMGARITHMETIC_MATRIX4F_H_
#define MEDIMGARITHMETIC_MATRIX4F_H_
...
public:
  ...
  inline const Vector3f get_translation() const { return m_Col3.get_xyz(); }
  ...
  inline const Vector4f get_col0() const { return m_Col0; }

  inline const Vector4f get_col1() const { return m_Col1; }

  inline const Vector4f get_col2() const { return m_Col2; }

  inline const Vector4f get_col3() const { return m_Col3; }
  ...
  inline Vector4f &operator[](const int col) { return *(&m_Col0 + col); }
  ...
  inline void prepend(const Matrix4f &myMatrix) { *this = myMatrix * (*this); }

  inline void append(const Matrix4f &myMatrix) { *this = (*this) * myMatrix; }
