#ifndef MEDIMGARITHMETIC_MATRIX4_H_
#define MEDIMGARITHMETIC_MATRIX4_H_
...
public:
  ...
  Matrix4(double m00, double m01, double m02, double m03, double m10,
  ...
  Matrix4(const Matrix4 &mat) { memcpy(this->_m, mat._m, sizeof(mat._m)); };
  ...
  inline Matrix4 operator*(const Matrix4 &m2) const {
    return Matrix4(_m[0] * m2._m[0] + _m[4] * m2._m[1] + _m[8] * m2._m[2] +
                   ...
                   _m[1] * m2._m[0] + _m[5] * m2._m[1] + _m[9] * m2._m[2] +
                       _m[13] * m2._m[3],
                   _m[2] * m2._m[0] + _m[6] * m2._m[1] + _m[10] * m2._m[2] +
                       _m[14] * m2._m[3],
                   _m[3] * m2._m[0] + _m[7] * m2._m[1] + _m[11] * m2._m[2] +
                       _m[15] * m2._m[3],
                   _m[0] * m2._m[4] + _m[4] * m2._m[5] + _m[8] * m2._m[6] +
                       _m[12] * m2._m[7],
                   _m[1] * m2._m[4] + _m[5] * m2._m[5] + _m[9] * m2._m[6] +
                       _m[13] * m2._m[7],
                   _m[2] * m2._m[4] + _m[6] * m2._m[5] + _m[10] * m2._m[6] +
                       _m[14] * m2._m[7],
                   _m[3] * m2._m[4] + _m[7] * m2._m[5] + _m[11] * m2._m[6] +
                       _m[15] * m2._m[7],
                   _m[0] * m2._m[8] + _m[4] * m2._m[9] + _m[8] * m2._m[10] +
                       _m[12] * m2._m[11],
                   _m[1] * m2._m[8] + _m[5] * m2._m[9] + _m[9] * m2._m[10] +
                       _m[13] * m2._m[11],
                   _m[2] * m2._m[8] + _m[6] * m2._m[9] + _m[10] * m2._m[10] +
                       _m[14] * m2._m[11],
                   _m[3] * m2._m[8] + _m[7] * m2._m[9] + _m[11] * m2._m[10] +
                       _m[15] * m2._m[11],
                   _m[0] * m2._m[12] + _m[4] * m2._m[13] + _m[8] * m2._m[14] +
                       _m[12] * m2._m[15],
                   _m[1] * m2._m[12] + _m[5] * m2._m[13] + _m[9] * m2._m[14] +
                       _m[13] * m2._m[15],
                   _m[2] * m2._m[12] + _m[6] * m2._m[13] + _m[10] * m2._m[14] +
                       _m[14] * m2._m[15],
                   _m[3] * m2._m[12] + _m[7] * m2._m[13] + _m[11] * m2._m[14] +
                       _m[15] * m2._m[15]);
  };
  ...
  inline Point3 operator*(const Point3 &pt) const {
    ...
    dw = 1.0 / dw;
    return Point3((_m[0] * pt.x + _m[4] * pt.y + _m[8] * pt.z + _m[12]) * dw,
  ...
  inline Matrix4 operator*(const double scale) const {
    return Matrix4(scale * _m[0], scale * _m[1], scale * _m[2], scale * _m[3],
                   scale * _m[4], scale * _m[5], scale * _m[6], scale * _m[7],
                   scale * _m[8], scale * _m[9], scale * _m[10], scale * _m[11],
                   scale * _m[12], scale * _m[13], scale * _m[14],
                   scale * _m[15]);
  };
  ...
  inline void prepend(const Matrix4 &mat) { *this = mat * (*this); };

  inline void append(const Matrix4 &mat) { *this = (*this) * mat; };
  ...
  inline Matrix4 get_transpose() const {
    return Matrix4(_m[0], _m[4], _m[8], _m[12], _m[1], _m[5], _m[9], _m[13],
                   _m[2], _m[6], _m[10], _m[14], _m[3], _m[7], _m[11], _m[15]);
  };
  ...
  inline Point3 transform(const Point3 &pt) const { return (*this) * pt; };

  inline Vector3 transform(const Vector3 &v) const { return (*this) * v; };
