#ifndef MEDIMGARITHMETIC_QUATERNION_4_H_
#define MEDIMGARITHMETIC_QUATERNION_4_H_
...
public:
  ...
  Matrix4 to_matrix() const {
    ...
    return Matrix4(ww + xx - yy - zz, xy + wz, xz - wy, 0, xy - wz,
                   ww - xx + yy - zz, yz + wx, 0, xz + wy, yz - wx,
                   ww - xx - yy + zz, 0, 0, 0, 0, 1);
  }
