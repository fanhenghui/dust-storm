...
class AppController;
class AppCommon_Export CmdHandlerBE_DBSendDICOM : public ICommandHandler {
public:
    CmdHandlerBE_DBSendDICOM(std::shared_ptr<AppController> controller);

    virtual ~CmdHandlerBE_DBSendDICOM();
