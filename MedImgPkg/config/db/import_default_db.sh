mysql -u root -p$1 -e"
use med_img_db;
INSERT INTO preprocess_type(pp_name, pp_desc) VALUES(\"init_segment_mask\",\"initialized segment mask(.rle)\");
INSERT INTO preprocess_type(pp_name, pp_desc) VALUES(\"lung_ai_intermediate_data\",\"lung ai algorithm intermediate data(.npy)\");
