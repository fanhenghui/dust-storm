...
//
//CudaBrickPool::CudaBrickPool(unsigned int brick_size, unsigned int brick_margin) :
//    _brick_size(brick_size),
//    _brick_margin(brick_margin),
//    _brick_count(0),
//    _volume_brick_info_cal(new CudaVolumeBrickInfoCalculator()),
//    _mask_brick_info_cal(new CudaMaskBrickInfoCalculator()) {
//    _brick_dim[0] = 1;
//    _brick_dim[1] = 1;
//    _brick_dim[2] = 1;
//}
//
//CudaBrickPool::~CudaBrickPool() {
//
//}
//
//void CudaBrickPool::set_volume(std::shared_ptr<ImageData> image_data) {
//    _volume = image_data;
//}
//
//void CudaBrickPool::set_mask(std::shared_ptr<ImageData> image_data) {
//    _mask = image_data;
//}
//
//void CudaBrickPool::set_volume_texture(cudaGLTextureReadOnly tex) {
//    _volume_texture = tex;
//}
//
//void CudaBrickPool::set_mask_texture(cudaGLTextureReadOnly tex) {
//    _mask_texture = tex;
//}
//
//void CudaBrickPool::get_brick_dim(unsigned int(&brick_dim)[3]) {
//    memcpy(brick_dim, _brick_dim, sizeof(unsigned int) * 3);
//}
//
//unsigned int CudaBrickPool::get_brick_count() const {
//    return _brick_count;
//}
//
//unsigned int CudaBrickPool::get_brick_size() const {
//    return _brick_size;
//}
//
//unsigned int CudaBrickPool::get_brick_margin() const {
//    return _brick_margin;
//}
//
//void CudaBrickPool::calculate_volume_brick_info() {
//    if (nullptr == _h_volume_brick_info_array) {
//        _h_volume_brick_info_array.reset(new VolumeBrickInfo[this->get_brick_count()]);
//        cudaMalloc(&_d_volume_brick_info_buffer, this->get_brick_count() * sizeof(float) * 2);
//        _cuda_mem_shield.add_shield(_d_volume_brick_info_buffer);
//    }
//
//    _volume_brick_info_cal->set_data(_volume);
//    _volume_brick_info_cal->set_data_texture(_volume_texture);
//    _volume_brick_info_cal->set_brick_info_array_host((char*)_h_volume_brick_info_array.get());
//    _volume_brick_info_cal->set_brick_info_array_device((char*)_d_volume_brick_info_buffer);
...
//}
//
//VolumeBrickInfo* CudaBrickPool::get_volume_brick_info() const {
//    return _h_volume_brick_info_array.get();
//}
//
//void CudaBrickPool::write_volume_brick_info(const std::string& path) {
//    RENDERALGO_CHECK_NULL_EXCEPTION(_h_volume_brick_info_array);
...
//            out << i << "\t" << _h_volume_brick_info_array[i].min << "\t" << _h_volume_brick_info_array[i].max <<
//                std::endl;
//        }
//
//        out.close();
...
//}
//
//void CudaBrickPool::add_visible_labels_cache(const std::vector<unsigned char>& vis_labels) {
//    _vis_labels_cache[LabelKey(vis_labels)] = (vis_labels);
//}
//
//void CudaBrickPool::get_visible_labels_cache(std::vector<std::vector<unsigned char>>& vis_labels) {
//    vis_labels.clear();
...
//}
//
//void CudaBrickPool::clear_visible_labels_cache() {
//    _vis_labels_cache.clear();
//}
//
//std::vector<std::vector<unsigned char>> CudaBrickPool::get_stored_visible_labels() {
...
//}
//
//void CudaBrickPool::calculate_mask_brick_info(const std::vector<unsigned char>& vis_labels) {
//    LabelKey key(vis_labels);
//    MaskBrickInfo* h_brick_info = this->get_mask_brick_info(vis_labels);
//
//    if (nullptr == h_brick_info) {
//        std::unique_ptr<MaskBrickInfo[]> h_info_array(new MaskBrickInfo[this->get_brick_count()]);
//        h_brick_info = h_info_array.get();
//        _mask_brick_info_array_set.insert(std::make_pair(key, std::move(h_info_array)));
//
//        int* d_info_array = nullptr;
//        cudaMalloc(&d_info_array, this->get_brick_count() * sizeof(int));
//
//        _mask_brick_info_buffer_set.insert(std::make_pair(key, d_info_array));
//        _cuda_mem_shield.add_shield(d_info_array);
//    }
//
//    _mask_brick_info_cal->set_data(_mask);
//    _mask_brick_info_cal->set_data_texture(_mask_texture);
//    _mask_brick_info_cal->set_brick_info_array_host((char*)h_brick_info);
//    _mask_brick_info_cal->set_brick_info_array_device((char*)_mask_brick_info_buffer_set[key]);
...
//}
//
//void CudaBrickPool::update_mask_brick_info(const AABBUI& aabb) {
//    for (auto it = _mask_brick_info_array_set.begin(); it != _mask_brick_info_array_set.end(); ++it) {
//        std::vector<unsigned char> vis_labels = LabelKey::extract_labels(it->first);
//        _mask_brick_info_cal->set_data(_mask);
//        _mask_brick_info_cal->set_data_texture(_mask_texture);
//        _mask_brick_info_cal->set_brick_info_array_host((char*)it->second.get());
//        _mask_brick_info_cal->set_brick_info_array_device((char*)_mask_brick_info_buffer_set[it->first]);
//        _mask_brick_info_cal->set_brick_size(_brick_size);
//        _mask_brick_info_cal->set_brick_margin(_brick_margin);
//        _mask_brick_info_cal->set_brick_dim(_brick_dim);
//        _mask_brick_info_cal->set_visible_labels(vis_labels);
...
//}
//
//MaskBrickInfo* CudaBrickPool::get_mask_brick_info(const std::vector<unsigned char>& vis_labels) const {
//    LabelKey key(vis_labels);
...
//}
//
//void CudaBrickPool::write_mask_brick_info(const std::string& path,
...
//}
//
//void CudaBrickPool::remove_mask_brick_info(const std::vector<unsigned char>& vis_labels) {
//    LabelKey key(vis_labels);
...
//        int* d_brick_info_array = it_buffer->second;
//        cudaFree(&d_brick_info_array);
//    }
//}
//
//void CudaBrickPool::remove_all_mask_brick_info() {
...
//}
//
//void CudaBrickPool::calculate_brick_geometry() {
...
//    }
//
//    //set vertex coordinate as color (not normliazed)
...
//}
//
//const BrickGeometry& CudaBrickPool::get_brick_geometry() const {
//    return _brick_geometry;
//}
//
//void CudaBrickPool::calculate_intercect_brick_range(const AABB& bounding, AABBI& brick_range) {
...
//}
//
//void CudaBrickPool::get_clipping_brick_geometry(const AABB& bounding, float* brick_vertex,
//    float* brick_color) {
...
//}
//
//void CudaBrickPool::debug_save_mask_info(const std::string& path)
//{
