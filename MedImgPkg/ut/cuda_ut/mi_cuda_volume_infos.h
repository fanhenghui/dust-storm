//#ifndef MI_CUDA_VOLUME_INFOS_H
//#define MI_CUDA_VOLUME_INFOS_H
//
...
//
//    std::vector<cudaGLTextureReadOnly> get_volume_texture();
//    std::vector<cudaGLTextureReadOnly> get_mask_texture();
//
...
//
//    std::vector<cudaGLTextureReadOnly> _volume_textures; // P.S here use vector for separate volume later
//    std::vector<cudaGLTextureReadOnly> _mask_textures;
//
