//#include "mi_cuda_volume_infos.h"
//
...
//}
//
//CudaVolumeInfos::CudaVolumeInfos() : _volume_dirty(false), _mask_dirty(false) {
//    _brick_pool.reset(new BrickPool(16, 2));
//}
//
//CudaVolumeInfos::~CudaVolumeInfos() {
//    finialize();
//}
//
//void CudaVolumeInfos::finialize() {
...
//}
//
//void CudaVolumeInfos::set_volume(std::shared_ptr<ImageData> image_data) {
//    try {
...
//}
//
//void CudaVolumeInfos::set_mask(std::shared_ptr<ImageData> image_data) {
//    try {
//        RENDERALGO_CHECK_NULL_EXCEPTION(image_data);
//
...
//}
//
//void CudaVolumeInfos::set_data_header(
//    std::shared_ptr<ImageDataHeader> data_header) {
//    _data_header = data_header;
//}
//
//std::vector<GLTexture3DPtr> CudaVolumeInfos::get_volume_texture() {
//    return _volume_textures;
//}
//
//std::vector<GLTexture3DPtr> CudaVolumeInfos::get_mask_texture() {
//    return _mask_textures;
//}
//
//std::shared_ptr<ImageData> CudaVolumeInfos::get_volume() {
//    return _volume_data;
//}
//
//std::shared_ptr<ImageData> CudaVolumeInfos::get_mask() {
//    return _mask_data;
//}
//
//void CudaVolumeInfos::update_mask(const unsigned int(&begin)[3],
...
//}
//
//void CudaVolumeInfos::refresh_update_mask() {
...
//}
//
//void CudaVolumeInfos::refresh_cache_mask_brick_info() {
...
//}
//
//void CudaVolumeInfos::refresh_stored_mask_brick_info() {
...
//}
//
//void CudaVolumeInfos::refresh_upload_mask() {
//    if (!_mask_dirty) {
//        return;
//    }
//
...
//}
//
//void CudaVolumeInfos::refresh_upload_volume() {
//    if (!_volume_dirty) {
//        return;
//    }
//
...
//}
//
//std::shared_ptr<ImageDataHeader> CudaVolumeInfos::get_data_header() {
//    return _data_header;
//}
//
//std::shared_ptr<BrickPool> CudaVolumeInfos::get_brick_pool() {
//    return _brick_pool;
//}
//
//std::shared_ptr<CameraCalculator> CudaVolumeInfos::get_camera_calculator() {
//    return _camera_calculator;
//}
//
//void CudaVolumeInfos::refresh() {
...
//}
//
//void CudaVolumeInfos::cache_original_mask() {
...
//}
//
//std::shared_ptr<ImageData> CudaVolumeInfos::get_cache_original_mask() {
