#ifndef PACS_COMMUNICATOR_H
#define PACS_COMMUNICATOR_H
...
public:
    ...
    bool initialize(const char * self_AE_title, const unsigned short self_port, const char * serive_ip_address, const unsigned short serive_port, const char * service_AE_title);
