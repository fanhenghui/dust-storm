...
AppDB::AppDB(): _connection(nullptr) {}

AppDB::~AppDB() {
    this->disconnect();
}

int AppDB::connect(const std::string& user, const std::string& ip_port,
...
int AppDB::get_series_path(const std::string& series_id, std::string& path, const std::string& tbl) {
...
int AppDB::get_all_item(std::vector<ImgItem>& items , const std::string& tbl) {
...
int AppDB::insert_item(const ImgItem& item) {
