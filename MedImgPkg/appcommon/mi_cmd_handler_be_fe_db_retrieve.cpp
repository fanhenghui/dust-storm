#include "mi_cmd_handler_be_fe_db_retrieve.h"
...
CmdHandlerBE_FEDBRetrieve::CmdHandlerBE_FEDBRetrieve(std::shared_ptr<AppController> controller)
    : _controller(controller) {}

CmdHandlerBE_FEDBRetrieve::~CmdHandlerBE_FEDBRetrieve() {}

int CmdHandlerBE_FEDBRetrieve::handle_command(const IPCDataHeader& dataheader, char* buffer) {
