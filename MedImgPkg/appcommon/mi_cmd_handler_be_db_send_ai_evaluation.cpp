#include "mi_cmd_handler_be_db_send_ai_evaluation.h"
...
CmdHandlerBE_DBSendAIEvaluation::CmdHandlerBE_DBSendAIEvaluation(std::shared_ptr<AppController> controller):
    _controller(controller) {

}

CmdHandlerBE_DBSendAIEvaluation::~CmdHandlerBE_DBSendAIEvaluation() {

}

int CmdHandlerBE_DBSendAIEvaluation::handle_command(const IPCDataHeader& ipcheader , char* buffer) {
