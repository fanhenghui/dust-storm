#include "mi_cmd_handler_be_db_send_preprocess_mask.h"
...
CmdHandlerBE_DBSendPreprocessMask::CmdHandlerBE_DBSendPreprocessMask(std::shared_ptr<AppController> controller):
    _controller(controller) {

}

CmdHandlerBE_DBSendPreprocessMask::~CmdHandlerBE_DBSendPreprocessMask() {

}

int CmdHandlerBE_DBSendPreprocessMask::handle_command(const IPCDataHeader& ipcheader , char* buffer) {
