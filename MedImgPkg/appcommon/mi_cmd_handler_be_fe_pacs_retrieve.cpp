#include "mi_cmd_handler_be_fe_pacs_retrieve.h"
...
CmdHandlerBE_FEPACSRetrieve::CmdHandlerBE_FEPACSRetrieve(std::shared_ptr<AppController> controller)
    : _controller(controller) {}

CmdHandlerBE_FEPACSRetrieve::~CmdHandlerBE_FEPACSRetrieve() {}

int CmdHandlerBE_FEPACSRetrieve::handle_command(const IPCDataHeader& dataheader, char* buffer) {
