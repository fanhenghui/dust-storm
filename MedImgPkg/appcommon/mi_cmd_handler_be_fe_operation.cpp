#include "mi_cmd_handler_be_fe_operation.h"
...
CmdHandlerBE_FEOperation::CmdHandlerBE_FEOperation(std::shared_ptr<AppController> controller):
    _controller(controller) {

}

CmdHandlerBE_FEOperation::~CmdHandlerBE_FEOperation() {

}

int CmdHandlerBE_FEOperation::handle_command(const IPCDataHeader& ipcheader , char* buffer) {
