#include "mi_cmd_handler_recv_dbs_error.h"
...
CmdHandlerRecvDBSError::CmdHandlerRecvDBSError(std::shared_ptr<AppController> controller):
    _controller(controller) {

}

CmdHandlerRecvDBSError::~CmdHandlerRecvDBSError() {

}

int CmdHandlerRecvDBSError::handle_command(const IPCDataHeader& ipcheader , char* buffer) {
