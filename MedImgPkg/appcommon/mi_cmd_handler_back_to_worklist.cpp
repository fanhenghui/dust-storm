#include "mi_cmd_handler_back_to_worklist.h"
...
CmdHandlerBackToWorklist::CmdHandlerBackToWorklist(
    std::shared_ptr<AppController> controller)
    : _controller(controller) {}

CmdHandlerBackToWorklist::~CmdHandlerBackToWorklist() {}

int CmdHandlerBackToWorklist::handle_command(const IPCDataHeader& ipcheader, char* buffer) {
