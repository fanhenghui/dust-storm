...
void MainWindow::refreshObjMask()
{
	...
	if (iObj < 0) {
        ...
        QImage emptyMask;
        //QImage emptyMask(tmp_org_img.size(), QImage::Format_Indexed8);
        //emptyMask.setColorTable(colorTable);
        ////emptyMask.fill(iBackgroundColor);
        ////emptyMask.setText("annotationObjType", objTypes[0]);
