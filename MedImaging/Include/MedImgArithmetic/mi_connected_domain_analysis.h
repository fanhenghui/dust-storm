#ifndef MED_IMGING_CONNECTED_DIMAIN_LABEL_H
#define MED_IMGING_CONNECTED_DIMAIN_LABEL_H
...
public:
    ...
    void get_27_n(const unsigned int x , const unsigned int y ,const unsigned int z , std::stack<POS>& s , unsigned char label , unsigned int& add)
    {
