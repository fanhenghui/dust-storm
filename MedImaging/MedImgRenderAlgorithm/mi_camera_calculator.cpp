...
//
//    const Matrix4& matvp2 = camera->get_view_projection_matrix();
//    Point3 p2 = matvp2.transform(pt);
//    p2.print();
//    std::cout << "\n";
//}
...
void CameraCalculator::calculate_default_mpr_center_world_i()
{
    ...
    {
        look_at -= view_dir*0.5*_volume_data->_spacing[_leftInfo.volume_coord/2];//取下整
    }
    ...
    {
        look_at -= view_dir*0.5*_volume_data->_spacing[_headInfo.volume_coord/2];//取下整
    }
    ...
    {
        look_at -= view_dir*0.5*_volume_data->_spacing[_posteriorInfo.volume_coord/2];//取下整
    }
