...
//
//GeneticAlg::GeneticAlg(double cross_rate, double mutation_rate, unsigned int pop_size, int chromosome_length, int gene_length):
...
//}
//
//void GeneticAlg::create_start_population()
//{
//    _chromosomes.clear();
...
//}
//
//unsigned int GeneticAlg::roulette_wheel_selection() const
//{
...
//}
//
//const GeneticAlg::Chromosome& GeneticAlg::get_fittest_chromosome() const
//{
//    return _chromosomes[_fittest_chromosome_id];
//}
//
//void GeneticAlg::update_fitness_scores_i()
//{
